...
import { CalendarDays, MapPin, FileCode, ImagePlus, Trash2 } from 'lucide-react';
...
export default function EntityForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col flex-1 min-h-0">
        ...
        <div className="p-6 space-y-8">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div>
                <label className="block text-sm font-medium text-[color:var(--pragmata-fg)] mb-2">Estado</label>
                <select
                  value={entityStatus}
                  onChange={(e) => setEntityStatus(e.target.value as EntityRow['entity_status'])}
              ...
              <div className="md:col-span-2">
                <label className="block text-sm font-medium text-[color:var(--pragmata-fg)] mb-2">Descripción</label>
                <textarea
                  value={description}
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                {existingImageUrls.length > 0 && (
                  <div className="mt-4">
                    <p className="text-xs text-[color:var(--pragmata-muted)] mb-2">Imágenes ya cargadas</p>
      ...
      <div className="px-6 py-4 border-t border-[color:var(--pragmata-border)] flex items-center justify-end gap-3 bg-[color:var(--pragmata-surface-2)] shrink-0">
