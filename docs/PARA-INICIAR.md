...
2. **Usuario god** (el que lo ve todo): el flujo que ya usas — crear usuario en **Auth** (Dashboard nube **o** Studio local `http://127.0.0.1:54323`), copiar UUID, ejecutar **`docs/database/02_seed_god_user.sql`** en el **SQL Editor** de *esa misma* instancia.
